...
public class Account {
    ...
    public static Account fromRecord(AccountRecord record) {
        return new Account(record.getId(), record.getCreatedat(), record.getUpdatedat(), Optional.ofNullable(record.getName()), Optional.ofNullable(record.getFacebookuserid()), Optional.ofNullable(record.getGoogleuserid()), record.getIsguest());
    }
}
